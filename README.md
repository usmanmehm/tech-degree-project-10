...
This app is designed to give users a visual interface for creating, reading, updating and deleting records for a library. The database has entries for books, patrons and what loans have been made, and the entries can be created/updated/removed as needed. 
